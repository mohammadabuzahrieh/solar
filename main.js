...
function calculateSolar() {
    ...
    var feedback="";
	feedback += "<p>Based on your average daily use of"+" "+ Math.round(dailyUseKw) + " KWH, you will need to purchase "+panelsNeeded+" "+ panelName+" solar to offset your electricity bill</p>";
	feedback += "<h2>Additional Benefits</h2>";
	...
	feedback += "<p>Realisitc watts needed per hour: "+ Math.round(realWattNeeds)+"watts/hour </p>";
	feedback += "<p>The "+ panelName+" you selected generates about "+panelOutput+" watts per hour</p>";
